...
public class CadastroPessoaDao implements DaoGenerica<CadastroPessoas>{
    ...
    public void inserir(CadastroPessoas cadastro) {
        ...
        String sql = "INSERT INTO cadbasico (nomecad, cpf, idsexo, email) VALUES (?,?,"
                + "(select idsexo from cadsexo where nomesexo = ?),?)";
    ...
    @Override
    public void alterar(CadastroPessoas cadastro) {
        String sql = "UPDATE cadbasico SET nomecad = ?, cpf = ?, idsexo = (select idsexo from cadsexo where nomesexo = ?), email = ? where idcad = ?";
    ...
    @Override
    public ArrayList<CadastroPessoas> consultar() {
        
        ArrayList<CadastroPessoas> listaCadastros = new ArrayList<CadastroPessoas>();
    ...
    public ArrayList<CadastroPessoas> consultar(String str) {
        ArrayList<CadastroPessoas> listaCadastrosStr = new ArrayList<CadastroPessoas>();
        String sql = "SELECT c.idcad, c.nomecad, c.cpf, c.email, s.nomesexo "+
                     "FROM cadbasico as c "+
                     "LEFT JOIN cadsexo AS s ON (s.idsexo = c.idsexo) "+
    ...
    public ArrayList<CadastroPessoas> dashboard() {
        ArrayList<CadastroPessoas> ListarDashBoard = new ArrayList<CadastroPessoas>();
